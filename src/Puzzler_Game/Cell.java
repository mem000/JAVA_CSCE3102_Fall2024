...
public class Cell extends JButton {
     ...
     * <b>Empty</b>.
     *
     * @param board  the grid that holds all the cells
     ...
     * @param row    the row of this Cell
     * @param column the column of this Cell
     * @param type   specifies the type of this cell
     */
     ...
     *
     * @param other other cell used for the comparison
     ...
     *
     * @param selected the new value for the attribute selected
     */
